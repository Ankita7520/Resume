                      ...
                      <div className='wanted'>
                        <div>
                          ...
                          <select name="" id="" onChange={(e) => handleInputskill(e, object.id, 'input2')} value={object.input2}>
                            <option value={object.input2}>Select</option>
                            <option value={object.input2}>Level 1</option>
                            <option value={object.input2}>Level 2</option>
                            <option value={object.input2}>Level 2</option>
                            <option value={object.input2}>Level 2</option>
                            <option value={object.input2}>Level 2</option>
                          </select>
      ...
      />
        ...
        <div>
          ...
          <div>
            ...
            <button className="icon-btn" onClick={certi}> <img src="https://p7.hiclipart.com/preview/522/461/307/computer-icons-academic-certificate-certification-diploma-training-course.jpg" alt="" className="icons" /> Courses</button>
          </div>
          <div>
          ...
          <div style={{textAlign:"center"}}>
              <div style={{ display: "flex" }} className="two-one1">
                <div>
                  ...
                  <div>
                    <p className="font" id="place"></p>
                  </div>
                  <div>
                 
                    
                    <div>
                      <p className="font" id="desh"></p>
                    </div>
                    <div>
                    {
                       date === "" ? <span></span> : <div>
              ...
              <div style={{display:"flex"}}>
                ...
                <div className="obj">
                  {
                    emp === "" ? <span></span> : <h3>Employment History</h3>
                  }
              ...
              <div className="obj">
              {
                 education   === undefined ? <span></span> : <h3>Education</h3>
                  }
              ...
              <div className="obj">
               ...
               {skill.map((object) => (  
                 <div key={object.id}>
                   <p className="inpo">{object.input1}{object.input2}</p>
                 </div>
               ))}
             </div>
                }
